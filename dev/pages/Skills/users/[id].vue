                ...
                <v-card class="mx-auto" max-width="400">
                    ...
                    <div class="d-flex teacher-profile mb-2">
                        <div class="img-container">
                            <v-img :src="relatedUser.user.img" class="prof-img" cover></v-img>
                        </div>
                    ...
                    <v-card-actions class="d-flex justify-space-between">
                        <v-rating :model-value="relatedUser.rating" color="amber" density="compact" size="small"
...
const getAllRelatedSkillUsers = async () => {
    await fetch(`http://127.0.0.1:8000/api/skill/${id}/users`)
        .then((res) => res.json())
